...
const mainNav = [
  ...
  { title: "Promotions", url: "/admin/promotions", icon: GraduationCap },
  { title: "Import Excel", url: "/admin/import", icon: FileSpreadsheet },
  { title: "Résultats", url: "/admin/results", icon: BookOpen },
];
